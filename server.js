...
app.get('/api/subscription/plans', (req, res) => {
    res.json({
        success: true, plans: [
            { id: 'free', name: 'FREE PLAN', price: 0, jobPosts: 2 },
            { id: 'bronze', name: 'BRONZE PLAN', price: 3500, jobPosts: 6 },
            { id: 'gold', name: 'GOLD PLAN', price: 7500, jobPosts: 10 },
            { id: 'platinum', name: 'PLATINUM PLAN', price: 14000, jobPosts: -1 }
        ]
    });
});
